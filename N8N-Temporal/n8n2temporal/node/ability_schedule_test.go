...
func TestAbilitySchedule_ValidateInput(t *testing.T) {
	a := &AbilitySchedule{BaseActivity: &BaseActivity{}}
	node := &WkFLowNode{ID: "ability", Name: "调度", Type: "*.abilitySchedule", Parameters: map[string]interface{}{"pb_file": "x.proto", "req_message": "Req", "rsp_message": "Rsp"}}
